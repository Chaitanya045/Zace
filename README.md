...
AGENT_TRANSIENT_RETRY_MAX_ATTEMPTS=1
AGENT_TRANSIENT_RETRY_MAX_DELAY_MS=1000
AGENT_READONLY_STAGNATION_WINDOW=4
AGENT_INTERRUPTED_RUN_RECOVERY_ENABLED=true
AGENT_WRITE_REGRESSION_ERROR_SPIKE=40
...
- `AGENT_TRANSIENT_RETRY_MAX_ATTEMPTS` (default: `1`)
- `AGENT_TRANSIENT_RETRY_MAX_DELAY_MS` (default: `1000`)
- `AGENT_READONLY_STAGNATION_WINDOW` (default: `4`)
- `AGENT_INTERRUPTED_RUN_RECOVERY_ENABLED` (default: `true`)
- `AGENT_WRITE_REGRESSION_ERROR_SPIKE` (default: `40`)

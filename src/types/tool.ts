...
export const toolResultArtifactsSchema = z.object({
  ...
  markerChangedFilesAccepted: z.array(z.string()).optional(),
  markerChangedFilesRejected: z.array(z.string()).optional(),
  markerValidationAcceptedCount: z.number().int().nonnegative().optional(),
  markerValidationRejectedCount: z.number().int().nonnegative().optional(),
